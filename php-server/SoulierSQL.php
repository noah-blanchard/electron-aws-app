...
interface SoulierSQL
{
  ...
  public const SQL_MODIFIER        = "UPDATE soulier SET nom = :nom, marque = :marque, description = :description, pointures = :pointures, fermeture = :fermeture, couleur = :couleur, materiaux = :materiaux, pourQui = :pourQui where id = :id;"; //TODO
}
?>